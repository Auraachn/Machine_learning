...
def fetch_table_data(table_name, identifiers):
    ...
    # Convert the fetched data to a list of dictionaries with column names
    formatted_data = [
...
def search_houses():
    ...
    # Use json.dumps to control the order of keys
    json_data = json.dumps(result, sort_keys=False)

    # Use the Response class to create the response with the correct content type
